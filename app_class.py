...
########################### PLAYING FUNCTIONS ##################################
    ...
    def playing_draw(self):
        ...
        self.draw_text('HIGH SCORE: {}'.format(self.player.high_score), self.screen, [WIDTH//2+60, 0], 18, WHITE, START_FONT)
        self.player.draw()
        for enemy in self.enemies:
            enemy.draw()
        pygame.display.update()
...
########################### GAME OVER FUNCTIONS ################################
    ...
    def game_over_events(self):
        self.player.high_score = max(self.player.current_score, self.player.high_score)
